...
<!-- ========================================================================= -->
  ...
  <xsl:template match="BlastOutput">
    ...
    <xsl:variable name="queryId" select="Iteration_query-ID"/>
    <xsl:variable name="queryDef" select="Iteration_query-def"/>
    <xsl:variable name="queryLen" select="Iteration_query-len"/>
